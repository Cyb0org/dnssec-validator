...
!define MUI_ICON "dnsseckey.ico"
!define MUI_UNICON "dnsseckey.ico"
...
section "-hidden.postinstall"
  ...
  !insertmacro _ReplaceInFile "cz.nic.validator.dnssec.json" "@DNSSEC_BINARY@" "$\"$0\\DNSSECcore-windows-x86.exe$\""
  Delete "$INSTDIR\cz.nic.validator.dnssec.json.old"
	...
	WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PROGRAM_NAME}" "DisplayIcon" "$\"$INSTDIR\dnsseckey.ico$\""
  WriteRegStr HKCU "Software\Google\Chrome\NativeMessagingHosts\cz.nic.validator.dnssec" "" "$INSTDIR\cz.nic.validator.dnssec.json"
  WriteRegStr HKCU "Software\Chromium\NativeMessagingHosts\cz.nic.validator.dnssec" "" "$INSTDIR\cz.nic.validator.dnssec.json"
